...
const localizeService = require('../main')('b620b691391023e2144cce84468d4f6a');
...
describe('Localize APIs', () => {
    ...
    describe('PROJECTS', () => {
        ...
        it('Should fail to create a new project', function (done) {
            ...
            localizeService.project.create(data, function (err, result) {
                console.log(err, result, 'qqqqqqq')
                err.should.not.be.eql('ssss');
                done();
            });
        });
